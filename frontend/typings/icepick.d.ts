declare module "icepick" {
   ...
   *
   */
  export function freeze<C>(coll: C): IFrozen<C>;
   ...
   *
   */
  export function thaw<C>(coll: IFrozen<C>): C;
   ...
   *
   */
  export function assocIn<C>(coll: C, path: string[], val: any): IFrozen<C>;
   ...
   *
   */
  export function dissocIn<C>(coll: C, path: string[]): IFrozen<C>;
  export const unsetIn: typeof assocIn;
  /**
   ...
   *
   */
  export function getIn<C>(coll: C, path: string[]): any;
  /**
  ...
  export interface IChainedObject<T extends {}> {
    ...
    setIn(path: string[], val: any): IChainedObject<T>;
